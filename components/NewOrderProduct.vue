    ...
    <div class="order-wrapper" @click="toggleRotation()" >
        <div class="order-product">
            <div class="product_image_group">
                <div class="product-images" v-for="(image, index) in getProductImages(order?.products)" :key="index">
            ...
            <svg v-if="showSvg" xmlns="http://www.w3.org/2000/svg" width="32" height="33" viewBox="0 0 32 33" fill="none" :class="{ 'rotate-down': isRotated }">
