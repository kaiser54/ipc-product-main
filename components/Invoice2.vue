  ...
  <div>
      ...
      <tr>
        ...
        <td>
          <span style="max-width: 176px">
            {{ data.order.streetAddress }}, {{ data.order.lga }}, {{ data.order.state }}.
            </span
          >
        </td>
      </tr>
    ...
    <table style="margin-top: 48px" class="orders">
      ...
      <tr v-for="(data, index) in data.order.products" :key="data._id">
        ...
        <td class="orders-data">{{ data.product.productName }}</td>
        <td class="orders-data">{{ data.quantity }}</td>
        <td class="orders-data">₦ {{ data.product.actualPrce }}</td>
