        ...
        <div class="mobile-nav">
          <div class="mobile-nav-content">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
              <path d="M5 7.00012H19" stroke="#565C69" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M5 12.0001H19" stroke="#565C69" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M5 17.0001H19" stroke="#565C69" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
            <p>Categories</p>
          </div>
        </div>
