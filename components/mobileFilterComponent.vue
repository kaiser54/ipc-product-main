                ...
                <div class="modal">
                    <div class="modal-msg">
                        <div class="head-x">
                            ...
                            <svg @click="closeModal" class="circle" xmlns="http://www.w3.org/2000/svg" width="16"
                                height="16" viewBox="0 0 16 16" fill="none">
                                <path d="M3.33301 12.6663L12.6663 3.33301M3.33301 3.33301L12.6663 12.6663L3.33301 3.33301Z"
                        ...
                        <div class="snippet-tab">
                            ...
                            <div class="filter-tabs">
                                <div v-for="(tab, index) in tabs" :key="index" class="tab tab-small"
                                    @click="toggleTab(index)" :class="{ clicked: activeTabs.includes(index) }">
                                    {{ tab }}
                                </div>
                            </div>
                        </div>
                                    ...
                                    <button class="datepicker-toggle-button">
                                        ...
                                        <span v-else class="btn-dsp">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                                ...
                                                <path
                                                    d="M2 4.0013C2 3.26492 2.59695 2.66797 3.33333 2.66797H12.6667C13.4031 2.66797 14 3.26492 14 4.0013V13.3346C14 14.071 13.4031 14.668 12.6667 14.668H3.33333C2.59695 14.668 2 14.071 2 13.3346V4.0013Z"
                                                    stroke="#303237" stroke-width="1.5" stroke-linecap="round"
                                                    stroke-linejoin="round" />
                                                <path d="M2 6.66797H14" stroke="#303237" stroke-width="2"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M10.666 1.33203V3.9987" stroke="#303237" stroke-width="2"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M5.33398 1.33203V3.9987" stroke="#303237" stroke-width="2"
                                                    stroke-linecap="round" stroke-linejoin="round" />
                                            </svg>
                                            <p>YYYY-MM-DD</p>
                                        </span>
