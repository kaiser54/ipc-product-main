<template>
  <section class="dashboard-nav-bar">
    <section class="dashboard-menu">
      <img src="../assets/images/ipc-logo.png" alt="IPC Logo branding Independence purchasing company" />
      <section class="menu">
          ...
          <div class="desktop-nav">
            <div class="nav-content">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path d="M5 7.00012H19" stroke="#565C69" stroke-width="2" stroke-linecap="round"
                  stroke-linejoin="round" />
                <path d="M5 12.0001H19" stroke="#565C69" stroke-width="2" stroke-linecap="round"
                  stroke-linejoin="round" />
                <path d="M5 17.0001H19" stroke="#565C69" stroke-width="2" stroke-linecap="round"
                  stroke-linejoin="round" />
              </svg>
              <p>Categories</p>
            </div>
            ...
            <div class="nav-content">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <path
                  ...
                  stroke="#565C69" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M15 11.0001C15 12.657 13.6569 14.0001 12 14.0001C10.3431 14.0001 9 12.657 9 11.0001"
                  stroke="#565C69" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
              <p>Track orders</p>
            </div>
            ...
            <div class="nav-content">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path
                  ...
                  stroke="#565C69" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M4 21V17C4 15.8954 4.89543 15 6 15H18C19.1046 15 20 15.8954 20 17V21" stroke="#565C69"
                  stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
              <p>Profile</p>
            </div>
              ...
              <div class="nav-content">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                  ...
                  <path d="M13 2.5V9H19" stroke="#565C69" stroke-width="2" stroke-linecap="round"
                    stroke-linejoin="round" />
                  <path d="M8 17H15" stroke="#303237" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M8 13H15" stroke="#303237" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                  <path d="M8 9H9" stroke="#303237" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                </svg>
                <p>FAQs</p>
              </div>
            </div>
