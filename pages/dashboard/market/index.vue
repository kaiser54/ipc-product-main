      ...
      <EmptySystem  @leavePage="cleared" :header="header" :snippet="snippet">
        ...
        <template v-slot:svg>
          ...
          >
            ...
            />
            <path
              d="M2.49567 7.52637L10.4231 14.4849H10.4278L13.8164 14.5565L9.4017 7.52637H2.49567Z"
              fill="#565C69"
            />
            <path
              d="M10.4266 14.4844L17.8672 21.0181L13.8152 14.556L10.4266 14.4844Z"
              fill="#7E8494"
            />
            <path
            ...
            />
            <path
              d="M13.762 7.52637L18.234 14.6472L49.0033 15.2962L51.5566 7.84136L51.1939 7.52637H13.762Z"
              fill="#565C69"
            />
            <path
            ...
            />
            <path
              d="M41.3635 41.6362L57.8674 56.1164L94.7695 55.0139L49.0046 15.2959L41.3635 41.6362Z"
              fill="#BDC0CE"
            />
            <path
              d="M18.2346 14.6475L27.5938 29.5525L41.3629 41.6368L49.0039 15.2965L18.2346 14.6475Z"
              fill="#7E8494"
            />
          </svg>
        </template>
