        ...
        <div class="wrapper">
          <div class="header">
            <div class="header-group">
              <h2 class="h2-medium header-text">Welcome back</h2>
              <svg
                width="32"
                height="32"
                viewBox="0 0 32 32"
          ...
          <form class="form-group">
            ...
            <div class="submit-reset">
              <button @click.prevent="submitLogin" class="btn primary-btn">Log in</button>
              <div class="pass-link">
                <p>
                  Forgot password?
